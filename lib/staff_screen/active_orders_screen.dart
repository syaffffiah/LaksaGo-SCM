                  ...
                  Row(
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () async {
                            final orderReady = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                            ...
                            if (orderReady == true) {
                              setState(() {
                                dummyOrders
                                    .remove(order); // Remove the specific order
                                print('Order removed: ${order.orderNumber}');
                                print('Remaining orders: $dummyOrders');
                              });
                            }
                          },
                          style: ElevatedButton.styleFrom(
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            setState(() {
                              selectedOrder =
                                  order; // Update the selected order
                            });
                            _showCancelReasonDialog(); // Show the cancellation dialog
                          },
                          style: ElevatedButton.styleFrom(
